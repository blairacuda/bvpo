    ...
    <div className="home">
      <div className="centerText">
        <p className="pageHeader">
            Welcome to the Buena Vista Parent Organization (BVPO)
        </p>
      </div>
        ...
        <p className="sectionHeader">
        Monthly BVPO meetings
        </p>

        <p className="basicText">
        BVPO meetings are typically held the first Monday following Site Council from 6:30 – 8:00pm in the school library.  Archived copies of meeting minutes are available in the school office.  All parents of children actively enrolled in the school are welcome to participate and vote (if present) at monthly BVPO meetings.  Please become actively involved and strengthen our school community.
        </p>

        <p className="sectionHeader">
        Parent Volunteers and Board Members
        </p>

        <p className="basicText">
        The BVPO is a Non-Profit Organization which relies upon Parent Volunteers each day helping out in the classrooms, organizing programs and events, and serving as Board and Committee Chair Members.  If you are interested in joining the BVPO Board please contact us or inquire for more information at the school office.
        </p>
    </div>
  );
}
